...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            OrderHeader orderHeader = await _db.OrderHeader.FirstOrDefaultAsync(m => m.Id == Id);
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            // Add email logic to notify that order is ready to pickup
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order has been ready for pickup.");
